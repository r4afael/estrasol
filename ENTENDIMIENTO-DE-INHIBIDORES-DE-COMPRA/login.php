...
if($nueva_consulta = $mysqli->prepare("SELECT DISTINCT us.idUsuario, us.nombre, us.usuario, us.pass,us.skin, us.idtipoUser, us.idlink,us.val, lp.skin, lp.link from usuarios2020 us
