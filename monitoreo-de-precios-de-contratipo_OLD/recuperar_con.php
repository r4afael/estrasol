<?php
$skin='monitoreo-de-precios-de-contratipo';
?>
<!DOCTYPE html>
<html lang="en">
					...
					<div class="col-sm-6 col-sm-offset-3">
						<div class="panel panel-default">
							...
							<center>
								...
								<form class="login100-form validate-form" action="" id="formrc" style=" display: inline-block;text-align: center; align-items: center;">
