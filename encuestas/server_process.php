<?php
	...
	*/
	...
	$aColumnas = array( 'id', 'nombres', 'apellidos','fecha_nacimiento','estado','ciudad','codigo_postal','celular','telefono_fijo','otro_telefono','email','email2','android','wifi','	experiencia_campo','experiencia_levantamiento','viajar','trabaja','cual','giro_tipo','ciudad_trabajo','inmega','medio','fecha');
