				...
				<div class="header-inner container">
					<div class="row">
						...
						<div class="col-md-4">
							...
							<li class="user-login"><i class="fa fa-sign-in"></i> BIENVENIDO: <?php echo $_SESSION['usuario']?></li>
								<li class="user-login"><i class="fa fa-sign-in"></i> <a href="cerrar_sesion.php" class="text-uppercase">Cerrar sesión</a></li>
							</ul>
						</div>
