...
if (!isset($_SESSION["usuario"])) {
	...
	$skin=$skin_global;
	$sql = "SELECT us.idUsuario, us.nombre, us.usuario, us.pass,us.val,us.skin, us.idtipoUser, us.idlink, lp.skin, lp.link from usuarios2020 us
            INNER JOIN linkspbi lp ON lp.idlink = us.idlink
            INNER JOIN  tipousuarios tu ON tu.idtipoUser = us.idtipoUser WHERE us.usuario = ? AND us.val = ? AND lp.skin = ? LIMIT 1";
...
<body>
	...
	<div id="content">
		...
		<div class="limiter">
			...
			<div id="content">
			    <div class="alert alert-danger" role="alert" id="error" style="display:none; text-align:center;">
			        <span> Datos no válidos, La contraseña no coincide</span>
		        </div>
		        <div class="alert alert-danger" role="alert" id="error2" style="display:none; text-align:center;">
			        <span> Datos no válidos, La contraseña debe tener al menos una mayúscula, un minúscula, un digito y un carácter especial</span>
		        </div>
