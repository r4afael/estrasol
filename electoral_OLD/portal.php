...
//echo $usuario;
$queryid = "SELECT * FROM `linkspbi` WHERE `skin` = 'electoral'";
...
?>
                    ...
                    <!--<iframe src="https://app.powerbi.com/view?r=eyJrIjoiZTM1NzVjMmQtOWUxMy00OGI1LWE2MzctZmU1YmM4ZTgyMjM1IiwidCI6ImVmMzUwYzMwLWE0OWYtNDg4NC1hY2M3LTM5ZWI2YTQ0ZDlhMiIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe>-->
...
<styly="non" iframe src="https://app.powerbi.com/view?r=eyJrIjoiMGQ5YTFmZDYtMTk5OC00MDQ5LdfgfejN2UtZDRiZDIwOTRhZDc3IiwidCI6ImVmMzUwYzMwLWE0OWYtNDg4NC1hY2M3LTM5ZWI2YTQ0ZDlhMiIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe> 
		...
		<script type='text/javascript'>
			document.oncontextmenu = function(){return false}
                   ...
                   var url="https://pricepointmonitor.com/electoral/portal.html?dummy="+(new Date()).getTime()
                   var complemento = "989";
