...
//echo $usuario;
$queryid = "SELECT * FROM `linkspbi` WHERE `skin` = 'ecogas'";
...
?>
                    ...
                    <!--<iframe src="https://app.powerbi.com/view?r=eyJrIjoiMjM4ODcyMzEtZjlmMC00OGUzLWJmYTQtMDEwODIyMDRjNGJhIiwidCI6ImVmMzUwYzMwLWE0OWYtNDg4NC1hY2M3LTM5ZWI2YTQ0ZDlhMiIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe>-->
...
<styly="non" iframe src="https://app.powerbi.com/view?r=eyJrIjoiMGQ5YTFmZDYtMTk5OC00MDQ5LdfgfejN2UtZDRiZDIwOTRhZDc3IiwidCI6ImVmMzUwYzMwLWE0OWYtNDg4NC1hY2M3LTM5ZWI2YTQ0ZDlhMiIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe> 
		...
		<script type='text/javascript'>
			document.oncontextmenu = function(){return false}
                   ...
                   var url="https://pricepointmonitor.com/ecogas/portal.html?dummy="+(new Date()).getTime()
                   var complemento = "989";
