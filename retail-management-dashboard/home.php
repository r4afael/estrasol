      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/hero_bg_3.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
              <!--<a href="inside.php" class="btn btn-white btn-outline-white py-3 px-5 rounded-0 btn-2">INSIDE<br> HOME CENTERS</a> -->
              <a href="sell.php" class="btn btn-white btn-outline-white py-3 px-5 rounded-0 btn-2">SELL OUT / SELL <br>IN HOME CENTERS</a><br>
              <!--<a href="ppm.php" class="btn btn-white btn-outline-white py-3 px-5 rounded-0 btn-2">PRICE POINT<br>MONITOR</a></p> -->
            </div>
          </div>
        </div>
      </div>  
