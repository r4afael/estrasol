<?php
header('Content-Type: text/html; charset=ISO-8859-1'); //Se muestra la consulta con acentos
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="container">
      <a href="index.php" class="navbar-brand d-flex align-items-center">
        ...
        <form class="d-flex" role="search">
          <input class="form-control me-2" type="search" name="termino" id="termino" placeholder="Buscar SKIN" aria-label="Search">
        </form>
